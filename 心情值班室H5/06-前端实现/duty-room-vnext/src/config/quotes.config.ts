// vNext quotes config — final, sourced from SoT §3 (master) + §4 (backup).
...
export const QUOTES: readonly RoleQuote[] = [
  // §3 Master Quotes
  q('A', '我没哭，是风太大', ['role_card'], 'master'),
  q('A', '泼出去的水连盆都可以不要', ['role_card'], 'master'),
  q('A', '高僧烧完剩舍利子，我烧完剩张嘴', ['role_card'], 'master'),
  q('B', '不是不合群，是低能量人群', ['role_card'], 'master'),
  q('B', '状态：隐身', ['role_card', 'preview'], 'master'),
  ...
  q('D', '形而上学，不行退学', ['role_card'], 'master'),
  ...
  q('A', '你对我冷淡我就对你冷漠', ['role_card'], 'backup'),
  q('A', '你们玩你们的，不用管我', ['role_card', 'result_support'], 'backup'),
  q('B', '在，但不在线', ['role_card', 'preview'], 'backup'),
  ...
  q('D', '虽然我不会做饭，但我点得一手好外卖', ['role_card'], 'backup'),
...
/** 取该角色的 role_card 用 quote (master 优先, 同 tier 内取第一条). */
