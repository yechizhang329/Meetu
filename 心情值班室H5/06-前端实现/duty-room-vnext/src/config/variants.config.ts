...
const SOT_VARIANTS: VariantSpec[] = [
  ...
  { sceneId: 'S2', roleId: 'E', tier: 'default', text: '这瓜有点烫嘴，容我细品。' },
  { sceneId: 'S2', roleId: 'E', tier: 'variant_2', text: '看到了，我先保留回复。' },
  { sceneId: 'S2', roleId: 'E', tier: 'variant_3', text: '收到，我心里有数。' },
  // S3 任务在那，但人还没启动
  ...
  { sceneId: 'S3', roleId: 'E', tier: 'default', text: '事情的发展就像我的银行卡余额，一点动静都没有。' },
  ...
  { sceneId: 'S4', roleId: 'E', tier: 'default', text: '今天我眼界大开。' },
  ...
  { sceneId: 'S5', roleId: 'E', tier: 'default', text: '前排出售瓜子矿泉水，你们尽情输出。' },
  { sceneId: 'S5', roleId: 'E', tier: 'variant_2', text: '你们玩开心，不用喊我了。' },
  { sceneId: 'S5', roleId: 'E', tier: 'variant_3', text: '听您的，下次叫我。' },
  // S6 这事离谱，但不想亲自开怼
  { sceneId: 'S6', roleId: 'E', tier: 'default', text: '啊对对对！' },
  { sceneId: 'S6', roleId: 'E', tier: 'variant_2', text: '行吧，挺好的，我都懂。' },
  { sceneId: 'S6', roleId: 'E', tier: 'variant_3', text: '可以，您说得都对。' },
