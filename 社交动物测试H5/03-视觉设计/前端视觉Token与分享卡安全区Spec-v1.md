...
| 朋友锐评 / 自我认领 / 氛围区 | y `960-1240` | 梗点 + 用户可配文认领短句 + 适合氛围 |
...
其中 1、9 可以弱化；2、3、4、6、7 是传播核心。

**自我认领短句定义**：给用户保存/转发时可直接当配文的第一人称短句，不是品牌评价，也不是朋友吐槽。
...
2. 每个结果必须有一个用户可自我认领/可配文的短句；
3. 每只动物必须有一个非普通姿态或道具；
4. 每张分享卡至少有一个轻微不规整元素：歪贴纸、划线、胶带、圈选、弹幕；
5. 文案可以犀利，但不能攻击用户；
6. 视觉可以抽象，但不能影响第一眼读懂结果。
